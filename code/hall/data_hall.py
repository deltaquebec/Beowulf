...
# test the function
df_raw = raw_df(r"C:\Users\delta\AppData\Local\Programs\Python\Python37\hw\project\hall")
# Save the dataframe to a CSV file
df_raw.to_csv('df_raw_hall.csv')
...
def clean_df(directory):
 ...
 # test the function
df_clean = clean_df(r"C:\Users\delta\AppData\Local\Programs\Python\Python37\hw\project\hall")
# Save the dataframe to a CSV file
df_clean.to_csv('df_clean_hall.csv')
